...
func (o *DeleteListingsItemReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 503:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[DELETE /listings/2021-08-01/items/{sellerId}/{sku}] deleteListingsItem", response, response.Code())
	}
}
...
// Code gets the status code for the delete listings item o k response
func (o *DeleteListingsItemOK) Code() int {
	return 200
}

func (o *DeleteListingsItemOK) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /listings/2021-08-01/items/{sellerId}/{sku}][%d] deleteListingsItemOK %s", 200, payload)
}
...
func (o *DeleteListingsItemOK) GetPayload() *models.ListingsItemSubmissionResponse {
	return o.Payload
}
...
// Code gets the status code for the delete listings item bad request response
func (o *DeleteListingsItemBadRequest) Code() int {
	return 400
}

func (o *DeleteListingsItemBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /listings/2021-08-01/items/{sellerId}/{sku}][%d] deleteListingsItemBadRequest %s", 400, payload)
}
...
func (o *DeleteListingsItemBadRequest) GetPayload() *models.ErrorList {
	return o.Payload
}
...
// Code gets the status code for the delete listings item forbidden response
func (o *DeleteListingsItemForbidden) Code() int {
	return 403
}

func (o *DeleteListingsItemForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /listings/2021-08-01/items/{sellerId}/{sku}][%d] deleteListingsItemForbidden %s", 403, payload)
}
...
func (o *DeleteListingsItemForbidden) GetPayload() *models.ErrorList {
	return o.Payload
}
...
// Code gets the status code for the delete listings item request entity too large response
func (o *DeleteListingsItemRequestEntityTooLarge) Code() int {
	return 413
}

func (o *DeleteListingsItemRequestEntityTooLarge) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /listings/2021-08-01/items/{sellerId}/{sku}][%d] deleteListingsItemRequestEntityTooLarge %s", 413, payload)
}
...
func (o *DeleteListingsItemRequestEntityTooLarge) GetPayload() *models.ErrorList {
	return o.Payload
}
...
// Code gets the status code for the delete listings item unsupported media type response
func (o *DeleteListingsItemUnsupportedMediaType) Code() int {
	return 415
}

func (o *DeleteListingsItemUnsupportedMediaType) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /listings/2021-08-01/items/{sellerId}/{sku}][%d] deleteListingsItemUnsupportedMediaType %s", 415, payload)
}
...
func (o *DeleteListingsItemUnsupportedMediaType) GetPayload() *models.ErrorList {
	return o.Payload
}
...
// Code gets the status code for the delete listings item too many requests response
func (o *DeleteListingsItemTooManyRequests) Code() int {
	return 429
}

func (o *DeleteListingsItemTooManyRequests) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /listings/2021-08-01/items/{sellerId}/{sku}][%d] deleteListingsItemTooManyRequests %s", 429, payload)
}
...
func (o *DeleteListingsItemTooManyRequests) GetPayload() *models.ErrorList {
	return o.Payload
}
...
// Code gets the status code for the delete listings item internal server error response
func (o *DeleteListingsItemInternalServerError) Code() int {
	return 500
}

func (o *DeleteListingsItemInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /listings/2021-08-01/items/{sellerId}/{sku}][%d] deleteListingsItemInternalServerError %s", 500, payload)
}
...
func (o *DeleteListingsItemInternalServerError) GetPayload() *models.ErrorList {
	return o.Payload
}
...
// Code gets the status code for the delete listings item service unavailable response
func (o *DeleteListingsItemServiceUnavailable) Code() int {
	return 503
}

func (o *DeleteListingsItemServiceUnavailable) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /listings/2021-08-01/items/{sellerId}/{sku}][%d] deleteListingsItemServiceUnavailable %s", 503, payload)
}
...
func (o *DeleteListingsItemServiceUnavailable) GetPayload() *models.ErrorList {
	return o.Payload
}
