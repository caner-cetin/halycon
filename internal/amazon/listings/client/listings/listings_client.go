...
// New creates a new listings API client with basic auth credentials.
...
// New creates a new listings API client with a bearer token for authentication.
// It takes the following parameters:
// - host: http host (github.com).
// - basePath: any base path for the API client ("/v1", "/v3").
// - scheme: http scheme ("http", "https").
...
/*
	SearchListingsItems Search for and return a list of selling partner listings items and their respective details.
