...
func (o *PutListingsItemReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 503:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[PUT /listings/2021-08-01/items/{sellerId}/{sku}] putListingsItem", response, response.Code())
	}
}
...
// Code gets the status code for the put listings item o k response
func (o *PutListingsItemOK) Code() int {
	return 200
}

func (o *PutListingsItemOK) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /listings/2021-08-01/items/{sellerId}/{sku}][%d] putListingsItemOK %s", 200, payload)
}
...
func (o *PutListingsItemOK) GetPayload() *models.ListingsItemSubmissionResponse {
	return o.Payload
}
...
// Code gets the status code for the put listings item bad request response
func (o *PutListingsItemBadRequest) Code() int {
	return 400
}

func (o *PutListingsItemBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /listings/2021-08-01/items/{sellerId}/{sku}][%d] putListingsItemBadRequest %s", 400, payload)
}
...
func (o *PutListingsItemBadRequest) GetPayload() *models.ErrorList {
	return o.Payload
}
...
// Code gets the status code for the put listings item forbidden response
func (o *PutListingsItemForbidden) Code() int {
	return 403
}

func (o *PutListingsItemForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /listings/2021-08-01/items/{sellerId}/{sku}][%d] putListingsItemForbidden %s", 403, payload)
}
...
func (o *PutListingsItemForbidden) GetPayload() *models.ErrorList {
	return o.Payload
}
...
// Code gets the status code for the put listings item request entity too large response
func (o *PutListingsItemRequestEntityTooLarge) Code() int {
	return 413
}

func (o *PutListingsItemRequestEntityTooLarge) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /listings/2021-08-01/items/{sellerId}/{sku}][%d] putListingsItemRequestEntityTooLarge %s", 413, payload)
}
...
func (o *PutListingsItemRequestEntityTooLarge) GetPayload() *models.ErrorList {
	return o.Payload
}
...
// Code gets the status code for the put listings item unsupported media type response
func (o *PutListingsItemUnsupportedMediaType) Code() int {
	return 415
}

func (o *PutListingsItemUnsupportedMediaType) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /listings/2021-08-01/items/{sellerId}/{sku}][%d] putListingsItemUnsupportedMediaType %s", 415, payload)
}
...
func (o *PutListingsItemUnsupportedMediaType) GetPayload() *models.ErrorList {
	return o.Payload
}
...
// Code gets the status code for the put listings item too many requests response
func (o *PutListingsItemTooManyRequests) Code() int {
	return 429
}

func (o *PutListingsItemTooManyRequests) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /listings/2021-08-01/items/{sellerId}/{sku}][%d] putListingsItemTooManyRequests %s", 429, payload)
}
...
func (o *PutListingsItemTooManyRequests) GetPayload() *models.ErrorList {
	return o.Payload
}
...
// Code gets the status code for the put listings item internal server error response
func (o *PutListingsItemInternalServerError) Code() int {
	return 500
}

func (o *PutListingsItemInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /listings/2021-08-01/items/{sellerId}/{sku}][%d] putListingsItemInternalServerError %s", 500, payload)
}
...
func (o *PutListingsItemInternalServerError) GetPayload() *models.ErrorList {
	return o.Payload
}
...
// Code gets the status code for the put listings item service unavailable response
func (o *PutListingsItemServiceUnavailable) Code() int {
	return 503
}

func (o *PutListingsItemServiceUnavailable) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /listings/2021-08-01/items/{sellerId}/{sku}][%d] putListingsItemServiceUnavailable %s", 503, payload)
}
...
func (o *PutListingsItemServiceUnavailable) GetPayload() *models.ErrorList {
	return o.Payload
}
