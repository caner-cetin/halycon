...
type PatchListingsItemParams struct {
	...
	*/
	Body *models.ListingsItemPatchRequest
...
func (o *PatchListingsItemParams) WithBody(body *models.ListingsItemPatchRequest) *PatchListingsItemParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the patch listings item params
func (o *PatchListingsItemParams) SetBody(body *models.ListingsItemPatchRequest) {
	o.Body = body
}
