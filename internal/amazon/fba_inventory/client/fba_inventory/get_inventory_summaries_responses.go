...
func (o *GetInventorySummariesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 503:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[GET /fba/inventory/v1/summaries] getInventorySummaries", response, response.Code())
	}
}
...
type GetInventorySummariesOK struct {
	...
	Payload *models.GetInventorySummariesResponse
}
...
// Code gets the status code for the get inventory summaries o k response
func (o *GetInventorySummariesOK) Code() int {
	return 200
}

func (o *GetInventorySummariesOK) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /fba/inventory/v1/summaries][%d] getInventorySummariesOK %s", 200, payload)
}
...
func (o *GetInventorySummariesOK) GetPayload() *models.GetInventorySummariesResponse {
	return o.Payload
}
...
func (o *GetInventorySummariesOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models.GetInventorySummariesResponse)
...
// Code gets the status code for the get inventory summaries bad request response
func (o *GetInventorySummariesBadRequest) Code() int {
	return 400
}

func (o *GetInventorySummariesBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /fba/inventory/v1/summaries][%d] getInventorySummariesBadRequest %s", 400, payload)
}
...
func (o *GetInventorySummariesBadRequest) GetPayload() *models.GetInventorySummariesResponse {
	return o.Payload
}
...
// Code gets the status code for the get inventory summaries forbidden response
func (o *GetInventorySummariesForbidden) Code() int {
	return 403
}

func (o *GetInventorySummariesForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /fba/inventory/v1/summaries][%d] getInventorySummariesForbidden %s", 403, payload)
}
...
func (o *GetInventorySummariesForbidden) GetPayload() *models.GetInventorySummariesResponse {
	return o.Payload
}
...
// Code gets the status code for the get inventory summaries not found response
func (o *GetInventorySummariesNotFound) Code() int {
	return 404
}

func (o *GetInventorySummariesNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /fba/inventory/v1/summaries][%d] getInventorySummariesNotFound %s", 404, payload)
}
...
func (o *GetInventorySummariesNotFound) GetPayload() *models.GetInventorySummariesResponse {
	return o.Payload
}
...
// Code gets the status code for the get inventory summaries too many requests response
func (o *GetInventorySummariesTooManyRequests) Code() int {
	return 429
}

func (o *GetInventorySummariesTooManyRequests) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /fba/inventory/v1/summaries][%d] getInventorySummariesTooManyRequests %s", 429, payload)
}
...
func (o *GetInventorySummariesTooManyRequests) GetPayload() *models.GetInventorySummariesResponse {
	return o.Payload
}
...
// Code gets the status code for the get inventory summaries internal server error response
func (o *GetInventorySummariesInternalServerError) Code() int {
	return 500
}

func (o *GetInventorySummariesInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /fba/inventory/v1/summaries][%d] getInventorySummariesInternalServerError %s", 500, payload)
}
...
func (o *GetInventorySummariesInternalServerError) GetPayload() *models.GetInventorySummariesResponse {
	return o.Payload
}
...
// Code gets the status code for the get inventory summaries service unavailable response
func (o *GetInventorySummariesServiceUnavailable) Code() int {
	return 503
}

func (o *GetInventorySummariesServiceUnavailable) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /fba/inventory/v1/summaries][%d] getInventorySummariesServiceUnavailable %s", 503, payload)
}
...
func (o *GetInventorySummariesServiceUnavailable) GetPayload() *models.GetInventorySummariesResponse {
	return o.Payload
}
