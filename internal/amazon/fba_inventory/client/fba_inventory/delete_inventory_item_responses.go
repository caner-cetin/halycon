...
func (o *DeleteInventoryItemReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 503:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[DELETE /fba/inventory/v1/items/{sellerSku}] deleteInventoryItem", response, response.Code())
	}
}
...
type DeleteInventoryItemOK struct {
	...
	Payload *models.DeleteInventoryItemResponse
}
...
// Code gets the status code for the delete inventory item o k response
func (o *DeleteInventoryItemOK) Code() int {
	return 200
}

func (o *DeleteInventoryItemOK) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /fba/inventory/v1/items/{sellerSku}][%d] deleteInventoryItemOK %s", 200, payload)
}
...
func (o *DeleteInventoryItemOK) GetPayload() *models.DeleteInventoryItemResponse {
	return o.Payload
}
...
func (o *DeleteInventoryItemOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models.DeleteInventoryItemResponse)
...
// Code gets the status code for the delete inventory item bad request response
func (o *DeleteInventoryItemBadRequest) Code() int {
	return 400
}

func (o *DeleteInventoryItemBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /fba/inventory/v1/items/{sellerSku}][%d] deleteInventoryItemBadRequest %s", 400, payload)
}
...
func (o *DeleteInventoryItemBadRequest) GetPayload() *models.DeleteInventoryItemResponse {
	return o.Payload
}
...
// Code gets the status code for the delete inventory item forbidden response
func (o *DeleteInventoryItemForbidden) Code() int {
	return 403
}

func (o *DeleteInventoryItemForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /fba/inventory/v1/items/{sellerSku}][%d] deleteInventoryItemForbidden %s", 403, payload)
}
...
func (o *DeleteInventoryItemForbidden) GetPayload() *models.DeleteInventoryItemResponse {
	return o.Payload
}
...
// Code gets the status code for the delete inventory item not found response
func (o *DeleteInventoryItemNotFound) Code() int {
	return 404
}

func (o *DeleteInventoryItemNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /fba/inventory/v1/items/{sellerSku}][%d] deleteInventoryItemNotFound %s", 404, payload)
}
...
func (o *DeleteInventoryItemNotFound) GetPayload() *models.DeleteInventoryItemResponse {
	return o.Payload
}
...
// Code gets the status code for the delete inventory item too many requests response
func (o *DeleteInventoryItemTooManyRequests) Code() int {
	return 429
}

func (o *DeleteInventoryItemTooManyRequests) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /fba/inventory/v1/items/{sellerSku}][%d] deleteInventoryItemTooManyRequests %s", 429, payload)
}
...
func (o *DeleteInventoryItemTooManyRequests) GetPayload() *models.DeleteInventoryItemResponse {
	return o.Payload
}
...
// Code gets the status code for the delete inventory item internal server error response
func (o *DeleteInventoryItemInternalServerError) Code() int {
	return 500
}

func (o *DeleteInventoryItemInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /fba/inventory/v1/items/{sellerSku}][%d] deleteInventoryItemInternalServerError %s", 500, payload)
}
...
func (o *DeleteInventoryItemInternalServerError) GetPayload() *models.DeleteInventoryItemResponse {
	return o.Payload
}
...
// Code gets the status code for the delete inventory item service unavailable response
func (o *DeleteInventoryItemServiceUnavailable) Code() int {
	return 503
}

func (o *DeleteInventoryItemServiceUnavailable) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /fba/inventory/v1/items/{sellerSku}][%d] deleteInventoryItemServiceUnavailable %s", 503, payload)
}
...
func (o *DeleteInventoryItemServiceUnavailable) GetPayload() *models.DeleteInventoryItemResponse {
	return o.Payload
}
