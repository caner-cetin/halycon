...
func (m *ListCatalogCategoriesResponse) validateErrors(formats strfmt.Registry) error {
...
func (m *ListCatalogCategoriesResponse) validatePayload(formats strfmt.Registry) error {
...
func (m *ListCatalogCategoriesResponse) contextValidateErrors(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ListCatalogCategoriesResponse) contextValidatePayload(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ListCatalogCategoriesResponse) UnmarshalBinary(b []byte) error {
	var res ListCatalogCategoriesResponse
