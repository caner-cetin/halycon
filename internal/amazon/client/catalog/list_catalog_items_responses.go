...
func (o *ListCatalogItemsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 503:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[GET /catalog/v0/items] listCatalogItems", response, response.Code())
	}
}
...
type ListCatalogItemsOK struct {
	...
	Payload *models.ListCatalogItemsResponse
}
...
// Code gets the status code for the list catalog items o k response
func (o *ListCatalogItemsOK) Code() int {
	return 200
}

func (o *ListCatalogItemsOK) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /catalog/v0/items][%d] listCatalogItemsOK %s", 200, payload)
}
...
func (o *ListCatalogItemsOK) GetPayload() *models.ListCatalogItemsResponse {
	return o.Payload
}
...
func (o *ListCatalogItemsOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models.ListCatalogItemsResponse)
...
// Code gets the status code for the list catalog items bad request response
func (o *ListCatalogItemsBadRequest) Code() int {
	return 400
}

func (o *ListCatalogItemsBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /catalog/v0/items][%d] listCatalogItemsBadRequest %s", 400, payload)
}
...
func (o *ListCatalogItemsBadRequest) GetPayload() *models.ListCatalogItemsResponse {
	return o.Payload
}
...
// Code gets the status code for the list catalog items unauthorized response
func (o *ListCatalogItemsUnauthorized) Code() int {
	return 401
}

func (o *ListCatalogItemsUnauthorized) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /catalog/v0/items][%d] listCatalogItemsUnauthorized %s", 401, payload)
}
...
func (o *ListCatalogItemsUnauthorized) GetPayload() *models.ListCatalogItemsResponse {
	return o.Payload
}
...
// Code gets the status code for the list catalog items forbidden response
func (o *ListCatalogItemsForbidden) Code() int {
	return 403
}

func (o *ListCatalogItemsForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /catalog/v0/items][%d] listCatalogItemsForbidden %s", 403, payload)
}
...
func (o *ListCatalogItemsForbidden) GetPayload() *models.ListCatalogItemsResponse {
	return o.Payload
}
...
// Code gets the status code for the list catalog items not found response
func (o *ListCatalogItemsNotFound) Code() int {
	return 404
}

func (o *ListCatalogItemsNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /catalog/v0/items][%d] listCatalogItemsNotFound %s", 404, payload)
}
...
func (o *ListCatalogItemsNotFound) GetPayload() *models.ListCatalogItemsResponse {
	return o.Payload
}
...
// Code gets the status code for the list catalog items too many requests response
func (o *ListCatalogItemsTooManyRequests) Code() int {
	return 429
}

func (o *ListCatalogItemsTooManyRequests) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /catalog/v0/items][%d] listCatalogItemsTooManyRequests %s", 429, payload)
}
...
func (o *ListCatalogItemsTooManyRequests) GetPayload() *models.ListCatalogItemsResponse {
	return o.Payload
}
...
// Code gets the status code for the list catalog items internal server error response
func (o *ListCatalogItemsInternalServerError) Code() int {
	return 500
}

func (o *ListCatalogItemsInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /catalog/v0/items][%d] listCatalogItemsInternalServerError %s", 500, payload)
}
...
func (o *ListCatalogItemsInternalServerError) GetPayload() *models.ListCatalogItemsResponse {
	return o.Payload
}
...
// Code gets the status code for the list catalog items service unavailable response
func (o *ListCatalogItemsServiceUnavailable) Code() int {
	return 503
}

func (o *ListCatalogItemsServiceUnavailable) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /catalog/v0/items][%d] listCatalogItemsServiceUnavailable %s", 503, payload)
}
...
func (o *ListCatalogItemsServiceUnavailable) GetPayload() *models.ListCatalogItemsResponse {
	return o.Payload
}
