...
func (o *ListInboundPlanItemsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 503:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[GET /inbound/fba/2024-03-20/inboundPlans/{inboundPlanId}/items] listInboundPlanItems", response, response.Code())
	}
}
...
type ListInboundPlanItemsOK struct {
	...
	Payload *models.ListInboundPlanItemsResponse
}
...
// Code gets the status code for the list inbound plan items o k response
func (o *ListInboundPlanItemsOK) Code() int {
	return 200
}

func (o *ListInboundPlanItemsOK) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /inbound/fba/2024-03-20/inboundPlans/{inboundPlanId}/items][%d] listInboundPlanItemsOK %s", 200, payload)
}
...
func (o *ListInboundPlanItemsOK) GetPayload() *models.ListInboundPlanItemsResponse {
	return o.Payload
}
...
func (o *ListInboundPlanItemsOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models.ListInboundPlanItemsResponse)
...
// Code gets the status code for the list inbound plan items bad request response
func (o *ListInboundPlanItemsBadRequest) Code() int {
	return 400
}

func (o *ListInboundPlanItemsBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /inbound/fba/2024-03-20/inboundPlans/{inboundPlanId}/items][%d] listInboundPlanItemsBadRequest %s", 400, payload)
}
...
func (o *ListInboundPlanItemsBadRequest) GetPayload() *models.ErrorList {
	return o.Payload
}
...
// Code gets the status code for the list inbound plan items forbidden response
func (o *ListInboundPlanItemsForbidden) Code() int {
	return 403
}

func (o *ListInboundPlanItemsForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /inbound/fba/2024-03-20/inboundPlans/{inboundPlanId}/items][%d] listInboundPlanItemsForbidden %s", 403, payload)
}
...
func (o *ListInboundPlanItemsForbidden) GetPayload() *models.ErrorList {
	return o.Payload
}
...
// Code gets the status code for the list inbound plan items not found response
func (o *ListInboundPlanItemsNotFound) Code() int {
	return 404
}

func (o *ListInboundPlanItemsNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /inbound/fba/2024-03-20/inboundPlans/{inboundPlanId}/items][%d] listInboundPlanItemsNotFound %s", 404, payload)
}
...
func (o *ListInboundPlanItemsNotFound) GetPayload() *models.ErrorList {
	return o.Payload
}
...
// Code gets the status code for the list inbound plan items request entity too large response
func (o *ListInboundPlanItemsRequestEntityTooLarge) Code() int {
	return 413
}

func (o *ListInboundPlanItemsRequestEntityTooLarge) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /inbound/fba/2024-03-20/inboundPlans/{inboundPlanId}/items][%d] listInboundPlanItemsRequestEntityTooLarge %s", 413, payload)
}
...
func (o *ListInboundPlanItemsRequestEntityTooLarge) GetPayload() *models.ErrorList {
	return o.Payload
}
...
// Code gets the status code for the list inbound plan items unsupported media type response
func (o *ListInboundPlanItemsUnsupportedMediaType) Code() int {
	return 415
}

func (o *ListInboundPlanItemsUnsupportedMediaType) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /inbound/fba/2024-03-20/inboundPlans/{inboundPlanId}/items][%d] listInboundPlanItemsUnsupportedMediaType %s", 415, payload)
}
...
func (o *ListInboundPlanItemsUnsupportedMediaType) GetPayload() *models.ErrorList {
	return o.Payload
}
...
// Code gets the status code for the list inbound plan items too many requests response
func (o *ListInboundPlanItemsTooManyRequests) Code() int {
	return 429
}

func (o *ListInboundPlanItemsTooManyRequests) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /inbound/fba/2024-03-20/inboundPlans/{inboundPlanId}/items][%d] listInboundPlanItemsTooManyRequests %s", 429, payload)
}
...
func (o *ListInboundPlanItemsTooManyRequests) GetPayload() *models.ErrorList {
	return o.Payload
}
...
// Code gets the status code for the list inbound plan items internal server error response
func (o *ListInboundPlanItemsInternalServerError) Code() int {
	return 500
}

func (o *ListInboundPlanItemsInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /inbound/fba/2024-03-20/inboundPlans/{inboundPlanId}/items][%d] listInboundPlanItemsInternalServerError %s", 500, payload)
}
...
func (o *ListInboundPlanItemsInternalServerError) GetPayload() *models.ErrorList {
	return o.Payload
}
...
// Code gets the status code for the list inbound plan items service unavailable response
func (o *ListInboundPlanItemsServiceUnavailable) Code() int {
	return 503
}

func (o *ListInboundPlanItemsServiceUnavailable) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /inbound/fba/2024-03-20/inboundPlans/{inboundPlanId}/items][%d] listInboundPlanItemsServiceUnavailable %s", 503, payload)
}
...
func (o *ListInboundPlanItemsServiceUnavailable) GetPayload() *models.ErrorList {
	return o.Payload
}
