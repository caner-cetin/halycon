...
func (o *ListInboundPlanBoxesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 503:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[GET /inbound/fba/2024-03-20/inboundPlans/{inboundPlanId}/boxes] listInboundPlanBoxes", response, response.Code())
	}
}
...
type ListInboundPlanBoxesOK struct {
	...
	Payload *models.ListInboundPlanBoxesResponse
}
...
// Code gets the status code for the list inbound plan boxes o k response
func (o *ListInboundPlanBoxesOK) Code() int {
	return 200
}

func (o *ListInboundPlanBoxesOK) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /inbound/fba/2024-03-20/inboundPlans/{inboundPlanId}/boxes][%d] listInboundPlanBoxesOK %s", 200, payload)
}
...
func (o *ListInboundPlanBoxesOK) GetPayload() *models.ListInboundPlanBoxesResponse {
	return o.Payload
}
...
func (o *ListInboundPlanBoxesOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models.ListInboundPlanBoxesResponse)
...
// Code gets the status code for the list inbound plan boxes bad request response
func (o *ListInboundPlanBoxesBadRequest) Code() int {
	return 400
}

func (o *ListInboundPlanBoxesBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /inbound/fba/2024-03-20/inboundPlans/{inboundPlanId}/boxes][%d] listInboundPlanBoxesBadRequest %s", 400, payload)
}
...
func (o *ListInboundPlanBoxesBadRequest) GetPayload() *models.ErrorList {
	return o.Payload
}
...
// Code gets the status code for the list inbound plan boxes forbidden response
func (o *ListInboundPlanBoxesForbidden) Code() int {
	return 403
}

func (o *ListInboundPlanBoxesForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /inbound/fba/2024-03-20/inboundPlans/{inboundPlanId}/boxes][%d] listInboundPlanBoxesForbidden %s", 403, payload)
}
...
func (o *ListInboundPlanBoxesForbidden) GetPayload() *models.ErrorList {
	return o.Payload
}
...
// Code gets the status code for the list inbound plan boxes not found response
func (o *ListInboundPlanBoxesNotFound) Code() int {
	return 404
}

func (o *ListInboundPlanBoxesNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /inbound/fba/2024-03-20/inboundPlans/{inboundPlanId}/boxes][%d] listInboundPlanBoxesNotFound %s", 404, payload)
}
...
func (o *ListInboundPlanBoxesNotFound) GetPayload() *models.ErrorList {
	return o.Payload
}
...
// Code gets the status code for the list inbound plan boxes request entity too large response
func (o *ListInboundPlanBoxesRequestEntityTooLarge) Code() int {
	return 413
}

func (o *ListInboundPlanBoxesRequestEntityTooLarge) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /inbound/fba/2024-03-20/inboundPlans/{inboundPlanId}/boxes][%d] listInboundPlanBoxesRequestEntityTooLarge %s", 413, payload)
}
...
func (o *ListInboundPlanBoxesRequestEntityTooLarge) GetPayload() *models.ErrorList {
	return o.Payload
}
...
// Code gets the status code for the list inbound plan boxes unsupported media type response
func (o *ListInboundPlanBoxesUnsupportedMediaType) Code() int {
	return 415
}

func (o *ListInboundPlanBoxesUnsupportedMediaType) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /inbound/fba/2024-03-20/inboundPlans/{inboundPlanId}/boxes][%d] listInboundPlanBoxesUnsupportedMediaType %s", 415, payload)
}
...
func (o *ListInboundPlanBoxesUnsupportedMediaType) GetPayload() *models.ErrorList {
	return o.Payload
}
...
// Code gets the status code for the list inbound plan boxes too many requests response
func (o *ListInboundPlanBoxesTooManyRequests) Code() int {
	return 429
}

func (o *ListInboundPlanBoxesTooManyRequests) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /inbound/fba/2024-03-20/inboundPlans/{inboundPlanId}/boxes][%d] listInboundPlanBoxesTooManyRequests %s", 429, payload)
}
...
func (o *ListInboundPlanBoxesTooManyRequests) GetPayload() *models.ErrorList {
	return o.Payload
}
...
// Code gets the status code for the list inbound plan boxes internal server error response
func (o *ListInboundPlanBoxesInternalServerError) Code() int {
	return 500
}

func (o *ListInboundPlanBoxesInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /inbound/fba/2024-03-20/inboundPlans/{inboundPlanId}/boxes][%d] listInboundPlanBoxesInternalServerError %s", 500, payload)
}
...
func (o *ListInboundPlanBoxesInternalServerError) GetPayload() *models.ErrorList {
	return o.Payload
}
...
// Code gets the status code for the list inbound plan boxes service unavailable response
func (o *ListInboundPlanBoxesServiceUnavailable) Code() int {
	return 503
}

func (o *ListInboundPlanBoxesServiceUnavailable) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /inbound/fba/2024-03-20/inboundPlans/{inboundPlanId}/boxes][%d] listInboundPlanBoxesServiceUnavailable %s", 503, payload)
}
...
func (o *ListInboundPlanBoxesServiceUnavailable) GetPayload() *models.ErrorList {
	return o.Payload
}
