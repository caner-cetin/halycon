...
func (o *ListShipmentContentUpdatePreviewsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 503:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[GET /inbound/fba/2024-03-20/inboundPlans/{inboundPlanId}/shipments/{shipmentId}/contentUpdatePreviews] listShipmentContentUpdatePreviews", response, response.Code())
	}
}
...
type ListShipmentContentUpdatePreviewsOK struct {
	...
	Payload *models.ListShipmentContentUpdatePreviewsResponse
}
...
// Code gets the status code for the list shipment content update previews o k response
func (o *ListShipmentContentUpdatePreviewsOK) Code() int {
	return 200
}

func (o *ListShipmentContentUpdatePreviewsOK) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /inbound/fba/2024-03-20/inboundPlans/{inboundPlanId}/shipments/{shipmentId}/contentUpdatePreviews][%d] listShipmentContentUpdatePreviewsOK %s", 200, payload)
}
...
func (o *ListShipmentContentUpdatePreviewsOK) GetPayload() *models.ListShipmentContentUpdatePreviewsResponse {
	return o.Payload
}
...
func (o *ListShipmentContentUpdatePreviewsOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models.ListShipmentContentUpdatePreviewsResponse)
...
// Code gets the status code for the list shipment content update previews bad request response
func (o *ListShipmentContentUpdatePreviewsBadRequest) Code() int {
	return 400
}

func (o *ListShipmentContentUpdatePreviewsBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /inbound/fba/2024-03-20/inboundPlans/{inboundPlanId}/shipments/{shipmentId}/contentUpdatePreviews][%d] listShipmentContentUpdatePreviewsBadRequest %s", 400, payload)
}
...
func (o *ListShipmentContentUpdatePreviewsBadRequest) GetPayload() *models.ErrorList {
	return o.Payload
}
...
// Code gets the status code for the list shipment content update previews forbidden response
func (o *ListShipmentContentUpdatePreviewsForbidden) Code() int {
	return 403
}

func (o *ListShipmentContentUpdatePreviewsForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /inbound/fba/2024-03-20/inboundPlans/{inboundPlanId}/shipments/{shipmentId}/contentUpdatePreviews][%d] listShipmentContentUpdatePreviewsForbidden %s", 403, payload)
}
...
func (o *ListShipmentContentUpdatePreviewsForbidden) GetPayload() *models.ErrorList {
	return o.Payload
}
...
// Code gets the status code for the list shipment content update previews not found response
func (o *ListShipmentContentUpdatePreviewsNotFound) Code() int {
	return 404
}

func (o *ListShipmentContentUpdatePreviewsNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /inbound/fba/2024-03-20/inboundPlans/{inboundPlanId}/shipments/{shipmentId}/contentUpdatePreviews][%d] listShipmentContentUpdatePreviewsNotFound %s", 404, payload)
}
...
func (o *ListShipmentContentUpdatePreviewsNotFound) GetPayload() *models.ErrorList {
	return o.Payload
}
...
// Code gets the status code for the list shipment content update previews request entity too large response
func (o *ListShipmentContentUpdatePreviewsRequestEntityTooLarge) Code() int {
	return 413
}

func (o *ListShipmentContentUpdatePreviewsRequestEntityTooLarge) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /inbound/fba/2024-03-20/inboundPlans/{inboundPlanId}/shipments/{shipmentId}/contentUpdatePreviews][%d] listShipmentContentUpdatePreviewsRequestEntityTooLarge %s", 413, payload)
}
...
func (o *ListShipmentContentUpdatePreviewsRequestEntityTooLarge) GetPayload() *models.ErrorList {
	return o.Payload
}
...
// Code gets the status code for the list shipment content update previews unsupported media type response
func (o *ListShipmentContentUpdatePreviewsUnsupportedMediaType) Code() int {
	return 415
}

func (o *ListShipmentContentUpdatePreviewsUnsupportedMediaType) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /inbound/fba/2024-03-20/inboundPlans/{inboundPlanId}/shipments/{shipmentId}/contentUpdatePreviews][%d] listShipmentContentUpdatePreviewsUnsupportedMediaType %s", 415, payload)
}
...
func (o *ListShipmentContentUpdatePreviewsUnsupportedMediaType) GetPayload() *models.ErrorList {
	return o.Payload
}
...
// Code gets the status code for the list shipment content update previews too many requests response
func (o *ListShipmentContentUpdatePreviewsTooManyRequests) Code() int {
	return 429
}

func (o *ListShipmentContentUpdatePreviewsTooManyRequests) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /inbound/fba/2024-03-20/inboundPlans/{inboundPlanId}/shipments/{shipmentId}/contentUpdatePreviews][%d] listShipmentContentUpdatePreviewsTooManyRequests %s", 429, payload)
}
...
func (o *ListShipmentContentUpdatePreviewsTooManyRequests) GetPayload() *models.ErrorList {
	return o.Payload
}
...
// Code gets the status code for the list shipment content update previews internal server error response
func (o *ListShipmentContentUpdatePreviewsInternalServerError) Code() int {
	return 500
}

func (o *ListShipmentContentUpdatePreviewsInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /inbound/fba/2024-03-20/inboundPlans/{inboundPlanId}/shipments/{shipmentId}/contentUpdatePreviews][%d] listShipmentContentUpdatePreviewsInternalServerError %s", 500, payload)
}
...
func (o *ListShipmentContentUpdatePreviewsInternalServerError) GetPayload() *models.ErrorList {
	return o.Payload
}
...
// Code gets the status code for the list shipment content update previews service unavailable response
func (o *ListShipmentContentUpdatePreviewsServiceUnavailable) Code() int {
	return 503
}

func (o *ListShipmentContentUpdatePreviewsServiceUnavailable) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /inbound/fba/2024-03-20/inboundPlans/{inboundPlanId}/shipments/{shipmentId}/contentUpdatePreviews][%d] listShipmentContentUpdatePreviewsServiceUnavailable %s", 503, payload)
}
...
func (o *ListShipmentContentUpdatePreviewsServiceUnavailable) GetPayload() *models.ErrorList {
	return o.Payload
}
