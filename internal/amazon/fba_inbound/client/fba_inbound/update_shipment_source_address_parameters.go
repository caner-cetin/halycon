...
type UpdateShipmentSourceAddressParams struct {
	...
	*/
	Body *models.UpdateShipmentSourceAddressRequest
...
func (o *UpdateShipmentSourceAddressParams) WithBody(body *models.UpdateShipmentSourceAddressRequest) *UpdateShipmentSourceAddressParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the update shipment source address params
func (o *UpdateShipmentSourceAddressParams) SetBody(body *models.UpdateShipmentSourceAddressRequest) {
	o.Body = body
}
