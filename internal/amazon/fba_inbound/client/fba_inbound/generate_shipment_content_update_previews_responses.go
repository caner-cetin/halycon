...
func (o *GenerateShipmentContentUpdatePreviewsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 503:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[POST /inbound/fba/2024-03-20/inboundPlans/{inboundPlanId}/shipments/{shipmentId}/contentUpdatePreviews] generateShipmentContentUpdatePreviews", response, response.Code())
	}
}
...
type GenerateShipmentContentUpdatePreviewsAccepted struct {
	...
	Payload *models.GenerateShipmentContentUpdatePreviewsResponse
}
...
// Code gets the status code for the generate shipment content update previews accepted response
func (o *GenerateShipmentContentUpdatePreviewsAccepted) Code() int {
	return 202
}

func (o *GenerateShipmentContentUpdatePreviewsAccepted) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /inbound/fba/2024-03-20/inboundPlans/{inboundPlanId}/shipments/{shipmentId}/contentUpdatePreviews][%d] generateShipmentContentUpdatePreviewsAccepted %s", 202, payload)
}
...
func (o *GenerateShipmentContentUpdatePreviewsAccepted) GetPayload() *models.GenerateShipmentContentUpdatePreviewsResponse {
	return o.Payload
}
...
func (o *GenerateShipmentContentUpdatePreviewsAccepted) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models.GenerateShipmentContentUpdatePreviewsResponse)
...
// Code gets the status code for the generate shipment content update previews bad request response
func (o *GenerateShipmentContentUpdatePreviewsBadRequest) Code() int {
	return 400
}

func (o *GenerateShipmentContentUpdatePreviewsBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /inbound/fba/2024-03-20/inboundPlans/{inboundPlanId}/shipments/{shipmentId}/contentUpdatePreviews][%d] generateShipmentContentUpdatePreviewsBadRequest %s", 400, payload)
}
...
func (o *GenerateShipmentContentUpdatePreviewsBadRequest) GetPayload() *models.ErrorList {
	return o.Payload
}
...
// Code gets the status code for the generate shipment content update previews forbidden response
func (o *GenerateShipmentContentUpdatePreviewsForbidden) Code() int {
	return 403
}

func (o *GenerateShipmentContentUpdatePreviewsForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /inbound/fba/2024-03-20/inboundPlans/{inboundPlanId}/shipments/{shipmentId}/contentUpdatePreviews][%d] generateShipmentContentUpdatePreviewsForbidden %s", 403, payload)
}
...
func (o *GenerateShipmentContentUpdatePreviewsForbidden) GetPayload() *models.ErrorList {
	return o.Payload
}
...
// Code gets the status code for the generate shipment content update previews not found response
func (o *GenerateShipmentContentUpdatePreviewsNotFound) Code() int {
	return 404
}

func (o *GenerateShipmentContentUpdatePreviewsNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /inbound/fba/2024-03-20/inboundPlans/{inboundPlanId}/shipments/{shipmentId}/contentUpdatePreviews][%d] generateShipmentContentUpdatePreviewsNotFound %s", 404, payload)
}
...
func (o *GenerateShipmentContentUpdatePreviewsNotFound) GetPayload() *models.ErrorList {
	return o.Payload
}
...
// Code gets the status code for the generate shipment content update previews request entity too large response
func (o *GenerateShipmentContentUpdatePreviewsRequestEntityTooLarge) Code() int {
	return 413
}

func (o *GenerateShipmentContentUpdatePreviewsRequestEntityTooLarge) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /inbound/fba/2024-03-20/inboundPlans/{inboundPlanId}/shipments/{shipmentId}/contentUpdatePreviews][%d] generateShipmentContentUpdatePreviewsRequestEntityTooLarge %s", 413, payload)
}
...
func (o *GenerateShipmentContentUpdatePreviewsRequestEntityTooLarge) GetPayload() *models.ErrorList {
	return o.Payload
}
...
// Code gets the status code for the generate shipment content update previews unsupported media type response
func (o *GenerateShipmentContentUpdatePreviewsUnsupportedMediaType) Code() int {
	return 415
}

func (o *GenerateShipmentContentUpdatePreviewsUnsupportedMediaType) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /inbound/fba/2024-03-20/inboundPlans/{inboundPlanId}/shipments/{shipmentId}/contentUpdatePreviews][%d] generateShipmentContentUpdatePreviewsUnsupportedMediaType %s", 415, payload)
}
...
func (o *GenerateShipmentContentUpdatePreviewsUnsupportedMediaType) GetPayload() *models.ErrorList {
	return o.Payload
}
...
// Code gets the status code for the generate shipment content update previews too many requests response
func (o *GenerateShipmentContentUpdatePreviewsTooManyRequests) Code() int {
	return 429
}

func (o *GenerateShipmentContentUpdatePreviewsTooManyRequests) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /inbound/fba/2024-03-20/inboundPlans/{inboundPlanId}/shipments/{shipmentId}/contentUpdatePreviews][%d] generateShipmentContentUpdatePreviewsTooManyRequests %s", 429, payload)
}
...
func (o *GenerateShipmentContentUpdatePreviewsTooManyRequests) GetPayload() *models.ErrorList {
	return o.Payload
}
...
// Code gets the status code for the generate shipment content update previews internal server error response
func (o *GenerateShipmentContentUpdatePreviewsInternalServerError) Code() int {
	return 500
}

func (o *GenerateShipmentContentUpdatePreviewsInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /inbound/fba/2024-03-20/inboundPlans/{inboundPlanId}/shipments/{shipmentId}/contentUpdatePreviews][%d] generateShipmentContentUpdatePreviewsInternalServerError %s", 500, payload)
}
...
func (o *GenerateShipmentContentUpdatePreviewsInternalServerError) GetPayload() *models.ErrorList {
	return o.Payload
}
...
// Code gets the status code for the generate shipment content update previews service unavailable response
func (o *GenerateShipmentContentUpdatePreviewsServiceUnavailable) Code() int {
	return 503
}

func (o *GenerateShipmentContentUpdatePreviewsServiceUnavailable) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /inbound/fba/2024-03-20/inboundPlans/{inboundPlanId}/shipments/{shipmentId}/contentUpdatePreviews][%d] generateShipmentContentUpdatePreviewsServiceUnavailable %s", 503, payload)
}
...
func (o *GenerateShipmentContentUpdatePreviewsServiceUnavailable) GetPayload() *models.ErrorList {
	return o.Payload
}
