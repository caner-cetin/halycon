...
func (o *UpdateItemComplianceDetailsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 503:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[PUT /inbound/fba/2024-03-20/items/compliance] updateItemComplianceDetails", response, response.Code())
	}
}
...
type UpdateItemComplianceDetailsAccepted struct {
	...
	Payload *models.UpdateItemComplianceDetailsResponse
}
...
// Code gets the status code for the update item compliance details accepted response
func (o *UpdateItemComplianceDetailsAccepted) Code() int {
	return 202
}

func (o *UpdateItemComplianceDetailsAccepted) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /inbound/fba/2024-03-20/items/compliance][%d] updateItemComplianceDetailsAccepted %s", 202, payload)
}
...
func (o *UpdateItemComplianceDetailsAccepted) GetPayload() *models.UpdateItemComplianceDetailsResponse {
	return o.Payload
}
...
func (o *UpdateItemComplianceDetailsAccepted) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models.UpdateItemComplianceDetailsResponse)
...
// Code gets the status code for the update item compliance details bad request response
func (o *UpdateItemComplianceDetailsBadRequest) Code() int {
	return 400
}

func (o *UpdateItemComplianceDetailsBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /inbound/fba/2024-03-20/items/compliance][%d] updateItemComplianceDetailsBadRequest %s", 400, payload)
}
...
func (o *UpdateItemComplianceDetailsBadRequest) GetPayload() *models.ErrorList {
	return o.Payload
}
...
// Code gets the status code for the update item compliance details forbidden response
func (o *UpdateItemComplianceDetailsForbidden) Code() int {
	return 403
}

func (o *UpdateItemComplianceDetailsForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /inbound/fba/2024-03-20/items/compliance][%d] updateItemComplianceDetailsForbidden %s", 403, payload)
}
...
func (o *UpdateItemComplianceDetailsForbidden) GetPayload() *models.ErrorList {
	return o.Payload
}
...
// Code gets the status code for the update item compliance details not found response
func (o *UpdateItemComplianceDetailsNotFound) Code() int {
	return 404
}

func (o *UpdateItemComplianceDetailsNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /inbound/fba/2024-03-20/items/compliance][%d] updateItemComplianceDetailsNotFound %s", 404, payload)
}
...
func (o *UpdateItemComplianceDetailsNotFound) GetPayload() *models.ErrorList {
	return o.Payload
}
...
// Code gets the status code for the update item compliance details request entity too large response
func (o *UpdateItemComplianceDetailsRequestEntityTooLarge) Code() int {
	return 413
}

func (o *UpdateItemComplianceDetailsRequestEntityTooLarge) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /inbound/fba/2024-03-20/items/compliance][%d] updateItemComplianceDetailsRequestEntityTooLarge %s", 413, payload)
}
...
func (o *UpdateItemComplianceDetailsRequestEntityTooLarge) GetPayload() *models.ErrorList {
	return o.Payload
}
...
// Code gets the status code for the update item compliance details unsupported media type response
func (o *UpdateItemComplianceDetailsUnsupportedMediaType) Code() int {
	return 415
}

func (o *UpdateItemComplianceDetailsUnsupportedMediaType) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /inbound/fba/2024-03-20/items/compliance][%d] updateItemComplianceDetailsUnsupportedMediaType %s", 415, payload)
}
...
func (o *UpdateItemComplianceDetailsUnsupportedMediaType) GetPayload() *models.ErrorList {
	return o.Payload
}
...
// Code gets the status code for the update item compliance details too many requests response
func (o *UpdateItemComplianceDetailsTooManyRequests) Code() int {
	return 429
}

func (o *UpdateItemComplianceDetailsTooManyRequests) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /inbound/fba/2024-03-20/items/compliance][%d] updateItemComplianceDetailsTooManyRequests %s", 429, payload)
}
...
func (o *UpdateItemComplianceDetailsTooManyRequests) GetPayload() *models.ErrorList {
	return o.Payload
}
...
// Code gets the status code for the update item compliance details internal server error response
func (o *UpdateItemComplianceDetailsInternalServerError) Code() int {
	return 500
}

func (o *UpdateItemComplianceDetailsInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /inbound/fba/2024-03-20/items/compliance][%d] updateItemComplianceDetailsInternalServerError %s", 500, payload)
}
...
func (o *UpdateItemComplianceDetailsInternalServerError) GetPayload() *models.ErrorList {
	return o.Payload
}
...
// Code gets the status code for the update item compliance details service unavailable response
func (o *UpdateItemComplianceDetailsServiceUnavailable) Code() int {
	return 503
}

func (o *UpdateItemComplianceDetailsServiceUnavailable) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /inbound/fba/2024-03-20/items/compliance][%d] updateItemComplianceDetailsServiceUnavailable %s", 503, payload)
}
...
func (o *UpdateItemComplianceDetailsServiceUnavailable) GetPayload() *models.ErrorList {
	return o.Payload
}
