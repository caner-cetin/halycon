...
type UpdateItemComplianceDetailsParams struct {
	...
	*/
	Body *models.UpdateItemComplianceDetailsRequest
...
func (o *UpdateItemComplianceDetailsParams) WithBody(body *models.UpdateItemComplianceDetailsRequest) *UpdateItemComplianceDetailsParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the update item compliance details params
func (o *UpdateItemComplianceDetailsParams) SetBody(body *models.UpdateItemComplianceDetailsRequest) {
	o.Body = body
}
