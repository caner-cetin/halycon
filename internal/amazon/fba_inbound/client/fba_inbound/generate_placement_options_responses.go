...
func (o *GeneratePlacementOptionsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 503:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[POST /inbound/fba/2024-03-20/inboundPlans/{inboundPlanId}/placementOptions] generatePlacementOptions", response, response.Code())
	}
}
...
type GeneratePlacementOptionsAccepted struct {
	...
	Payload *models.GeneratePlacementOptionsResponse
}
...
// Code gets the status code for the generate placement options accepted response
func (o *GeneratePlacementOptionsAccepted) Code() int {
	return 202
}

func (o *GeneratePlacementOptionsAccepted) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /inbound/fba/2024-03-20/inboundPlans/{inboundPlanId}/placementOptions][%d] generatePlacementOptionsAccepted %s", 202, payload)
}
...
func (o *GeneratePlacementOptionsAccepted) GetPayload() *models.GeneratePlacementOptionsResponse {
	return o.Payload
}
...
func (o *GeneratePlacementOptionsAccepted) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models.GeneratePlacementOptionsResponse)
...
// Code gets the status code for the generate placement options bad request response
func (o *GeneratePlacementOptionsBadRequest) Code() int {
	return 400
}

func (o *GeneratePlacementOptionsBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /inbound/fba/2024-03-20/inboundPlans/{inboundPlanId}/placementOptions][%d] generatePlacementOptionsBadRequest %s", 400, payload)
}
...
func (o *GeneratePlacementOptionsBadRequest) GetPayload() *models.ErrorList {
	return o.Payload
}
...
// Code gets the status code for the generate placement options forbidden response
func (o *GeneratePlacementOptionsForbidden) Code() int {
	return 403
}

func (o *GeneratePlacementOptionsForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /inbound/fba/2024-03-20/inboundPlans/{inboundPlanId}/placementOptions][%d] generatePlacementOptionsForbidden %s", 403, payload)
}
...
func (o *GeneratePlacementOptionsForbidden) GetPayload() *models.ErrorList {
	return o.Payload
}
...
// Code gets the status code for the generate placement options not found response
func (o *GeneratePlacementOptionsNotFound) Code() int {
	return 404
}

func (o *GeneratePlacementOptionsNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /inbound/fba/2024-03-20/inboundPlans/{inboundPlanId}/placementOptions][%d] generatePlacementOptionsNotFound %s", 404, payload)
}
...
func (o *GeneratePlacementOptionsNotFound) GetPayload() *models.ErrorList {
	return o.Payload
}
...
// Code gets the status code for the generate placement options request entity too large response
func (o *GeneratePlacementOptionsRequestEntityTooLarge) Code() int {
	return 413
}

func (o *GeneratePlacementOptionsRequestEntityTooLarge) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /inbound/fba/2024-03-20/inboundPlans/{inboundPlanId}/placementOptions][%d] generatePlacementOptionsRequestEntityTooLarge %s", 413, payload)
}
...
func (o *GeneratePlacementOptionsRequestEntityTooLarge) GetPayload() *models.ErrorList {
	return o.Payload
}
...
// Code gets the status code for the generate placement options unsupported media type response
func (o *GeneratePlacementOptionsUnsupportedMediaType) Code() int {
	return 415
}

func (o *GeneratePlacementOptionsUnsupportedMediaType) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /inbound/fba/2024-03-20/inboundPlans/{inboundPlanId}/placementOptions][%d] generatePlacementOptionsUnsupportedMediaType %s", 415, payload)
}
...
func (o *GeneratePlacementOptionsUnsupportedMediaType) GetPayload() *models.ErrorList {
	return o.Payload
}
...
// Code gets the status code for the generate placement options too many requests response
func (o *GeneratePlacementOptionsTooManyRequests) Code() int {
	return 429
}

func (o *GeneratePlacementOptionsTooManyRequests) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /inbound/fba/2024-03-20/inboundPlans/{inboundPlanId}/placementOptions][%d] generatePlacementOptionsTooManyRequests %s", 429, payload)
}
...
func (o *GeneratePlacementOptionsTooManyRequests) GetPayload() *models.ErrorList {
	return o.Payload
}
...
// Code gets the status code for the generate placement options internal server error response
func (o *GeneratePlacementOptionsInternalServerError) Code() int {
	return 500
}

func (o *GeneratePlacementOptionsInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /inbound/fba/2024-03-20/inboundPlans/{inboundPlanId}/placementOptions][%d] generatePlacementOptionsInternalServerError %s", 500, payload)
}
...
func (o *GeneratePlacementOptionsInternalServerError) GetPayload() *models.ErrorList {
	return o.Payload
}
...
// Code gets the status code for the generate placement options service unavailable response
func (o *GeneratePlacementOptionsServiceUnavailable) Code() int {
	return 503
}

func (o *GeneratePlacementOptionsServiceUnavailable) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /inbound/fba/2024-03-20/inboundPlans/{inboundPlanId}/placementOptions][%d] generatePlacementOptionsServiceUnavailable %s", 503, payload)
}
...
func (o *GeneratePlacementOptionsServiceUnavailable) GetPayload() *models.ErrorList {
	return o.Payload
}
