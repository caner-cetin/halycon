...
type CreateInboundPlanParams struct {
	...
	*/
	Body *models.CreateInboundPlanRequest
...
func (o *CreateInboundPlanParams) WithBody(body *models.CreateInboundPlanRequest) *CreateInboundPlanParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the create inbound plan params
func (o *CreateInboundPlanParams) SetBody(body *models.CreateInboundPlanRequest) {
	o.Body = body
}
