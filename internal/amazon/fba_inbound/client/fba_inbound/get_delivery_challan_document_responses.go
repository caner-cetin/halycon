...
func (o *GetDeliveryChallanDocumentReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 503:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[GET /inbound/fba/2024-03-20/inboundPlans/{inboundPlanId}/shipments/{shipmentId}/deliveryChallanDocument] getDeliveryChallanDocument", response, response.Code())
	}
}
...
type GetDeliveryChallanDocumentOK struct {
	...
	Payload *models.GetDeliveryChallanDocumentResponse
}
...
// Code gets the status code for the get delivery challan document o k response
func (o *GetDeliveryChallanDocumentOK) Code() int {
	return 200
}

func (o *GetDeliveryChallanDocumentOK) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /inbound/fba/2024-03-20/inboundPlans/{inboundPlanId}/shipments/{shipmentId}/deliveryChallanDocument][%d] getDeliveryChallanDocumentOK %s", 200, payload)
}
...
func (o *GetDeliveryChallanDocumentOK) GetPayload() *models.GetDeliveryChallanDocumentResponse {
	return o.Payload
}
...
func (o *GetDeliveryChallanDocumentOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models.GetDeliveryChallanDocumentResponse)
...
// Code gets the status code for the get delivery challan document bad request response
func (o *GetDeliveryChallanDocumentBadRequest) Code() int {
	return 400
}

func (o *GetDeliveryChallanDocumentBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /inbound/fba/2024-03-20/inboundPlans/{inboundPlanId}/shipments/{shipmentId}/deliveryChallanDocument][%d] getDeliveryChallanDocumentBadRequest %s", 400, payload)
}
...
func (o *GetDeliveryChallanDocumentBadRequest) GetPayload() *models.ErrorList {
	return o.Payload
}
...
// Code gets the status code for the get delivery challan document forbidden response
func (o *GetDeliveryChallanDocumentForbidden) Code() int {
	return 403
}

func (o *GetDeliveryChallanDocumentForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /inbound/fba/2024-03-20/inboundPlans/{inboundPlanId}/shipments/{shipmentId}/deliveryChallanDocument][%d] getDeliveryChallanDocumentForbidden %s", 403, payload)
}
...
func (o *GetDeliveryChallanDocumentForbidden) GetPayload() *models.ErrorList {
	return o.Payload
}
...
// Code gets the status code for the get delivery challan document not found response
func (o *GetDeliveryChallanDocumentNotFound) Code() int {
	return 404
}

func (o *GetDeliveryChallanDocumentNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /inbound/fba/2024-03-20/inboundPlans/{inboundPlanId}/shipments/{shipmentId}/deliveryChallanDocument][%d] getDeliveryChallanDocumentNotFound %s", 404, payload)
}
...
func (o *GetDeliveryChallanDocumentNotFound) GetPayload() *models.ErrorList {
	return o.Payload
}
...
// Code gets the status code for the get delivery challan document request entity too large response
func (o *GetDeliveryChallanDocumentRequestEntityTooLarge) Code() int {
	return 413
}

func (o *GetDeliveryChallanDocumentRequestEntityTooLarge) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /inbound/fba/2024-03-20/inboundPlans/{inboundPlanId}/shipments/{shipmentId}/deliveryChallanDocument][%d] getDeliveryChallanDocumentRequestEntityTooLarge %s", 413, payload)
}
...
func (o *GetDeliveryChallanDocumentRequestEntityTooLarge) GetPayload() *models.ErrorList {
	return o.Payload
}
...
// Code gets the status code for the get delivery challan document unsupported media type response
func (o *GetDeliveryChallanDocumentUnsupportedMediaType) Code() int {
	return 415
}

func (o *GetDeliveryChallanDocumentUnsupportedMediaType) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /inbound/fba/2024-03-20/inboundPlans/{inboundPlanId}/shipments/{shipmentId}/deliveryChallanDocument][%d] getDeliveryChallanDocumentUnsupportedMediaType %s", 415, payload)
}
...
func (o *GetDeliveryChallanDocumentUnsupportedMediaType) GetPayload() *models.ErrorList {
	return o.Payload
}
...
// Code gets the status code for the get delivery challan document too many requests response
func (o *GetDeliveryChallanDocumentTooManyRequests) Code() int {
	return 429
}

func (o *GetDeliveryChallanDocumentTooManyRequests) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /inbound/fba/2024-03-20/inboundPlans/{inboundPlanId}/shipments/{shipmentId}/deliveryChallanDocument][%d] getDeliveryChallanDocumentTooManyRequests %s", 429, payload)
}
...
func (o *GetDeliveryChallanDocumentTooManyRequests) GetPayload() *models.ErrorList {
	return o.Payload
}
...
// Code gets the status code for the get delivery challan document internal server error response
func (o *GetDeliveryChallanDocumentInternalServerError) Code() int {
	return 500
}

func (o *GetDeliveryChallanDocumentInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /inbound/fba/2024-03-20/inboundPlans/{inboundPlanId}/shipments/{shipmentId}/deliveryChallanDocument][%d] getDeliveryChallanDocumentInternalServerError %s", 500, payload)
}
...
func (o *GetDeliveryChallanDocumentInternalServerError) GetPayload() *models.ErrorList {
	return o.Payload
}
...
// Code gets the status code for the get delivery challan document service unavailable response
func (o *GetDeliveryChallanDocumentServiceUnavailable) Code() int {
	return 503
}

func (o *GetDeliveryChallanDocumentServiceUnavailable) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /inbound/fba/2024-03-20/inboundPlans/{inboundPlanId}/shipments/{shipmentId}/deliveryChallanDocument][%d] getDeliveryChallanDocumentServiceUnavailable %s", 503, payload)
}
...
func (o *GetDeliveryChallanDocumentServiceUnavailable) GetPayload() *models.ErrorList {
	return o.Payload
}
