...
func (o *ListShipmentItemsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 503:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[GET /inbound/fba/2024-03-20/inboundPlans/{inboundPlanId}/shipments/{shipmentId}/items] listShipmentItems", response, response.Code())
	}
}
...
type ListShipmentItemsOK struct {
	...
	Payload *models.ListShipmentItemsResponse
}
...
// Code gets the status code for the list shipment items o k response
func (o *ListShipmentItemsOK) Code() int {
	return 200
}

func (o *ListShipmentItemsOK) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /inbound/fba/2024-03-20/inboundPlans/{inboundPlanId}/shipments/{shipmentId}/items][%d] listShipmentItemsOK %s", 200, payload)
}
...
func (o *ListShipmentItemsOK) GetPayload() *models.ListShipmentItemsResponse {
	return o.Payload
}
...
func (o *ListShipmentItemsOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models.ListShipmentItemsResponse)
...
// Code gets the status code for the list shipment items bad request response
func (o *ListShipmentItemsBadRequest) Code() int {
	return 400
}

func (o *ListShipmentItemsBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /inbound/fba/2024-03-20/inboundPlans/{inboundPlanId}/shipments/{shipmentId}/items][%d] listShipmentItemsBadRequest %s", 400, payload)
}
...
func (o *ListShipmentItemsBadRequest) GetPayload() *models.ErrorList {
	return o.Payload
}
...
// Code gets the status code for the list shipment items forbidden response
func (o *ListShipmentItemsForbidden) Code() int {
	return 403
}

func (o *ListShipmentItemsForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /inbound/fba/2024-03-20/inboundPlans/{inboundPlanId}/shipments/{shipmentId}/items][%d] listShipmentItemsForbidden %s", 403, payload)
}
...
func (o *ListShipmentItemsForbidden) GetPayload() *models.ErrorList {
	return o.Payload
}
...
// Code gets the status code for the list shipment items not found response
func (o *ListShipmentItemsNotFound) Code() int {
	return 404
}

func (o *ListShipmentItemsNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /inbound/fba/2024-03-20/inboundPlans/{inboundPlanId}/shipments/{shipmentId}/items][%d] listShipmentItemsNotFound %s", 404, payload)
}
...
func (o *ListShipmentItemsNotFound) GetPayload() *models.ErrorList {
	return o.Payload
}
...
// Code gets the status code for the list shipment items request entity too large response
func (o *ListShipmentItemsRequestEntityTooLarge) Code() int {
	return 413
}

func (o *ListShipmentItemsRequestEntityTooLarge) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /inbound/fba/2024-03-20/inboundPlans/{inboundPlanId}/shipments/{shipmentId}/items][%d] listShipmentItemsRequestEntityTooLarge %s", 413, payload)
}
...
func (o *ListShipmentItemsRequestEntityTooLarge) GetPayload() *models.ErrorList {
	return o.Payload
}
...
// Code gets the status code for the list shipment items unsupported media type response
func (o *ListShipmentItemsUnsupportedMediaType) Code() int {
	return 415
}

func (o *ListShipmentItemsUnsupportedMediaType) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /inbound/fba/2024-03-20/inboundPlans/{inboundPlanId}/shipments/{shipmentId}/items][%d] listShipmentItemsUnsupportedMediaType %s", 415, payload)
}
...
func (o *ListShipmentItemsUnsupportedMediaType) GetPayload() *models.ErrorList {
	return o.Payload
}
...
// Code gets the status code for the list shipment items too many requests response
func (o *ListShipmentItemsTooManyRequests) Code() int {
	return 429
}

func (o *ListShipmentItemsTooManyRequests) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /inbound/fba/2024-03-20/inboundPlans/{inboundPlanId}/shipments/{shipmentId}/items][%d] listShipmentItemsTooManyRequests %s", 429, payload)
}
...
func (o *ListShipmentItemsTooManyRequests) GetPayload() *models.ErrorList {
	return o.Payload
}
...
// Code gets the status code for the list shipment items internal server error response
func (o *ListShipmentItemsInternalServerError) Code() int {
	return 500
}

func (o *ListShipmentItemsInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /inbound/fba/2024-03-20/inboundPlans/{inboundPlanId}/shipments/{shipmentId}/items][%d] listShipmentItemsInternalServerError %s", 500, payload)
}
...
func (o *ListShipmentItemsInternalServerError) GetPayload() *models.ErrorList {
	return o.Payload
}
...
// Code gets the status code for the list shipment items service unavailable response
func (o *ListShipmentItemsServiceUnavailable) Code() int {
	return 503
}

func (o *ListShipmentItemsServiceUnavailable) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /inbound/fba/2024-03-20/inboundPlans/{inboundPlanId}/shipments/{shipmentId}/items][%d] listShipmentItemsServiceUnavailable %s", 503, payload)
}
...
func (o *ListShipmentItemsServiceUnavailable) GetPayload() *models.ErrorList {
	return o.Payload
}
