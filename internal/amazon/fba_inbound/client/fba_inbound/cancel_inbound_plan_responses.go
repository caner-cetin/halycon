...
func (o *CancelInboundPlanReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 503:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[PUT /inbound/fba/2024-03-20/inboundPlans/{inboundPlanId}/cancellation] cancelInboundPlan", response, response.Code())
	}
}
...
type CancelInboundPlanAccepted struct {
	...
	Payload *models.CancelInboundPlanResponse
}
...
// Code gets the status code for the cancel inbound plan accepted response
func (o *CancelInboundPlanAccepted) Code() int {
	return 202
}

func (o *CancelInboundPlanAccepted) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /inbound/fba/2024-03-20/inboundPlans/{inboundPlanId}/cancellation][%d] cancelInboundPlanAccepted %s", 202, payload)
}
...
func (o *CancelInboundPlanAccepted) GetPayload() *models.CancelInboundPlanResponse {
	return o.Payload
}
...
func (o *CancelInboundPlanAccepted) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models.CancelInboundPlanResponse)
...
// Code gets the status code for the cancel inbound plan bad request response
func (o *CancelInboundPlanBadRequest) Code() int {
	return 400
}

func (o *CancelInboundPlanBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /inbound/fba/2024-03-20/inboundPlans/{inboundPlanId}/cancellation][%d] cancelInboundPlanBadRequest %s", 400, payload)
}
...
func (o *CancelInboundPlanBadRequest) GetPayload() *models.ErrorList {
	return o.Payload
}
...
// Code gets the status code for the cancel inbound plan forbidden response
func (o *CancelInboundPlanForbidden) Code() int {
	return 403
}

func (o *CancelInboundPlanForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /inbound/fba/2024-03-20/inboundPlans/{inboundPlanId}/cancellation][%d] cancelInboundPlanForbidden %s", 403, payload)
}
...
func (o *CancelInboundPlanForbidden) GetPayload() *models.ErrorList {
	return o.Payload
}
...
// Code gets the status code for the cancel inbound plan not found response
func (o *CancelInboundPlanNotFound) Code() int {
	return 404
}

func (o *CancelInboundPlanNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /inbound/fba/2024-03-20/inboundPlans/{inboundPlanId}/cancellation][%d] cancelInboundPlanNotFound %s", 404, payload)
}
...
func (o *CancelInboundPlanNotFound) GetPayload() *models.ErrorList {
	return o.Payload
}
...
// Code gets the status code for the cancel inbound plan request entity too large response
func (o *CancelInboundPlanRequestEntityTooLarge) Code() int {
	return 413
}

func (o *CancelInboundPlanRequestEntityTooLarge) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /inbound/fba/2024-03-20/inboundPlans/{inboundPlanId}/cancellation][%d] cancelInboundPlanRequestEntityTooLarge %s", 413, payload)
}
...
func (o *CancelInboundPlanRequestEntityTooLarge) GetPayload() *models.ErrorList {
	return o.Payload
}
...
// Code gets the status code for the cancel inbound plan unsupported media type response
func (o *CancelInboundPlanUnsupportedMediaType) Code() int {
	return 415
}

func (o *CancelInboundPlanUnsupportedMediaType) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /inbound/fba/2024-03-20/inboundPlans/{inboundPlanId}/cancellation][%d] cancelInboundPlanUnsupportedMediaType %s", 415, payload)
}
...
func (o *CancelInboundPlanUnsupportedMediaType) GetPayload() *models.ErrorList {
	return o.Payload
}
...
// Code gets the status code for the cancel inbound plan too many requests response
func (o *CancelInboundPlanTooManyRequests) Code() int {
	return 429
}

func (o *CancelInboundPlanTooManyRequests) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /inbound/fba/2024-03-20/inboundPlans/{inboundPlanId}/cancellation][%d] cancelInboundPlanTooManyRequests %s", 429, payload)
}
...
func (o *CancelInboundPlanTooManyRequests) GetPayload() *models.ErrorList {
	return o.Payload
}
...
// Code gets the status code for the cancel inbound plan internal server error response
func (o *CancelInboundPlanInternalServerError) Code() int {
	return 500
}

func (o *CancelInboundPlanInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /inbound/fba/2024-03-20/inboundPlans/{inboundPlanId}/cancellation][%d] cancelInboundPlanInternalServerError %s", 500, payload)
}
...
func (o *CancelInboundPlanInternalServerError) GetPayload() *models.ErrorList {
	return o.Payload
}
...
// Code gets the status code for the cancel inbound plan service unavailable response
func (o *CancelInboundPlanServiceUnavailable) Code() int {
	return 503
}

func (o *CancelInboundPlanServiceUnavailable) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /inbound/fba/2024-03-20/inboundPlans/{inboundPlanId}/cancellation][%d] cancelInboundPlanServiceUnavailable %s", 503, payload)
}
...
func (o *CancelInboundPlanServiceUnavailable) GetPayload() *models.ErrorList {
	return o.Payload
}
