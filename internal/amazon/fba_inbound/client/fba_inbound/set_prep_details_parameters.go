...
type SetPrepDetailsParams struct {
	...
	*/
	Body *models.SetPrepDetailsRequest
...
func (o *SetPrepDetailsParams) WithBody(body *models.SetPrepDetailsRequest) *SetPrepDetailsParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the set prep details params
func (o *SetPrepDetailsParams) SetBody(body *models.SetPrepDetailsRequest) {
	o.Body = body
}
