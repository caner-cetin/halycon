...
func (o *GeneratePackingOptionsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 503:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[POST /inbound/fba/2024-03-20/inboundPlans/{inboundPlanId}/packingOptions] generatePackingOptions", response, response.Code())
	}
}
...
type GeneratePackingOptionsAccepted struct {
	...
	Payload *models.GeneratePackingOptionsResponse
}
...
// Code gets the status code for the generate packing options accepted response
func (o *GeneratePackingOptionsAccepted) Code() int {
	return 202
}

func (o *GeneratePackingOptionsAccepted) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /inbound/fba/2024-03-20/inboundPlans/{inboundPlanId}/packingOptions][%d] generatePackingOptionsAccepted %s", 202, payload)
}
...
func (o *GeneratePackingOptionsAccepted) GetPayload() *models.GeneratePackingOptionsResponse {
	return o.Payload
}
...
func (o *GeneratePackingOptionsAccepted) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models.GeneratePackingOptionsResponse)
...
// Code gets the status code for the generate packing options bad request response
func (o *GeneratePackingOptionsBadRequest) Code() int {
	return 400
}

func (o *GeneratePackingOptionsBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /inbound/fba/2024-03-20/inboundPlans/{inboundPlanId}/packingOptions][%d] generatePackingOptionsBadRequest %s", 400, payload)
}
...
func (o *GeneratePackingOptionsBadRequest) GetPayload() *models.ErrorList {
	return o.Payload
}
...
// Code gets the status code for the generate packing options forbidden response
func (o *GeneratePackingOptionsForbidden) Code() int {
	return 403
}

func (o *GeneratePackingOptionsForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /inbound/fba/2024-03-20/inboundPlans/{inboundPlanId}/packingOptions][%d] generatePackingOptionsForbidden %s", 403, payload)
}
...
func (o *GeneratePackingOptionsForbidden) GetPayload() *models.ErrorList {
	return o.Payload
}
...
// Code gets the status code for the generate packing options not found response
func (o *GeneratePackingOptionsNotFound) Code() int {
	return 404
}

func (o *GeneratePackingOptionsNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /inbound/fba/2024-03-20/inboundPlans/{inboundPlanId}/packingOptions][%d] generatePackingOptionsNotFound %s", 404, payload)
}
...
func (o *GeneratePackingOptionsNotFound) GetPayload() *models.ErrorList {
	return o.Payload
}
...
// Code gets the status code for the generate packing options request entity too large response
func (o *GeneratePackingOptionsRequestEntityTooLarge) Code() int {
	return 413
}

func (o *GeneratePackingOptionsRequestEntityTooLarge) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /inbound/fba/2024-03-20/inboundPlans/{inboundPlanId}/packingOptions][%d] generatePackingOptionsRequestEntityTooLarge %s", 413, payload)
}
...
func (o *GeneratePackingOptionsRequestEntityTooLarge) GetPayload() *models.ErrorList {
	return o.Payload
}
...
// Code gets the status code for the generate packing options unsupported media type response
func (o *GeneratePackingOptionsUnsupportedMediaType) Code() int {
	return 415
}

func (o *GeneratePackingOptionsUnsupportedMediaType) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /inbound/fba/2024-03-20/inboundPlans/{inboundPlanId}/packingOptions][%d] generatePackingOptionsUnsupportedMediaType %s", 415, payload)
}
...
func (o *GeneratePackingOptionsUnsupportedMediaType) GetPayload() *models.ErrorList {
	return o.Payload
}
...
// Code gets the status code for the generate packing options too many requests response
func (o *GeneratePackingOptionsTooManyRequests) Code() int {
	return 429
}

func (o *GeneratePackingOptionsTooManyRequests) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /inbound/fba/2024-03-20/inboundPlans/{inboundPlanId}/packingOptions][%d] generatePackingOptionsTooManyRequests %s", 429, payload)
}
...
func (o *GeneratePackingOptionsTooManyRequests) GetPayload() *models.ErrorList {
	return o.Payload
}
...
// Code gets the status code for the generate packing options internal server error response
func (o *GeneratePackingOptionsInternalServerError) Code() int {
	return 500
}

func (o *GeneratePackingOptionsInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /inbound/fba/2024-03-20/inboundPlans/{inboundPlanId}/packingOptions][%d] generatePackingOptionsInternalServerError %s", 500, payload)
}
...
func (o *GeneratePackingOptionsInternalServerError) GetPayload() *models.ErrorList {
	return o.Payload
}
...
// Code gets the status code for the generate packing options service unavailable response
func (o *GeneratePackingOptionsServiceUnavailable) Code() int {
	return 503
}

func (o *GeneratePackingOptionsServiceUnavailable) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /inbound/fba/2024-03-20/inboundPlans/{inboundPlanId}/packingOptions][%d] generatePackingOptionsServiceUnavailable %s", 503, payload)
}
...
func (o *GeneratePackingOptionsServiceUnavailable) GetPayload() *models.ErrorList {
	return o.Payload
}
