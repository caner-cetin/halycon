...
type UpdateShipmentTrackingDetailsParams struct {
	...
	*/
	Body *models.UpdateShipmentTrackingDetailsRequest
...
func (o *UpdateShipmentTrackingDetailsParams) WithBody(body *models.UpdateShipmentTrackingDetailsRequest) *UpdateShipmentTrackingDetailsParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the update shipment tracking details params
func (o *UpdateShipmentTrackingDetailsParams) SetBody(body *models.UpdateShipmentTrackingDetailsRequest) {
	o.Body = body
}
