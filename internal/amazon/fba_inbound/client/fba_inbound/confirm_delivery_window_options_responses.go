...
func (o *ConfirmDeliveryWindowOptionsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 503:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[POST /inbound/fba/2024-03-20/inboundPlans/{inboundPlanId}/shipments/{shipmentId}/deliveryWindowOptions/{deliveryWindowOptionId}/confirmation] confirmDeliveryWindowOptions", response, response.Code())
	}
}
...
type ConfirmDeliveryWindowOptionsAccepted struct {
	...
	Payload *models.ConfirmDeliveryWindowOptionsResponse
}
...
// Code gets the status code for the confirm delivery window options accepted response
func (o *ConfirmDeliveryWindowOptionsAccepted) Code() int {
	return 202
}

func (o *ConfirmDeliveryWindowOptionsAccepted) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /inbound/fba/2024-03-20/inboundPlans/{inboundPlanId}/shipments/{shipmentId}/deliveryWindowOptions/{deliveryWindowOptionId}/confirmation][%d] confirmDeliveryWindowOptionsAccepted %s", 202, payload)
}
...
func (o *ConfirmDeliveryWindowOptionsAccepted) GetPayload() *models.ConfirmDeliveryWindowOptionsResponse {
	return o.Payload
}
...
func (o *ConfirmDeliveryWindowOptionsAccepted) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models.ConfirmDeliveryWindowOptionsResponse)
...
// Code gets the status code for the confirm delivery window options bad request response
func (o *ConfirmDeliveryWindowOptionsBadRequest) Code() int {
	return 400
}

func (o *ConfirmDeliveryWindowOptionsBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /inbound/fba/2024-03-20/inboundPlans/{inboundPlanId}/shipments/{shipmentId}/deliveryWindowOptions/{deliveryWindowOptionId}/confirmation][%d] confirmDeliveryWindowOptionsBadRequest %s", 400, payload)
}
...
func (o *ConfirmDeliveryWindowOptionsBadRequest) GetPayload() *models.ErrorList {
	return o.Payload
}
...
// Code gets the status code for the confirm delivery window options forbidden response
func (o *ConfirmDeliveryWindowOptionsForbidden) Code() int {
	return 403
}

func (o *ConfirmDeliveryWindowOptionsForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /inbound/fba/2024-03-20/inboundPlans/{inboundPlanId}/shipments/{shipmentId}/deliveryWindowOptions/{deliveryWindowOptionId}/confirmation][%d] confirmDeliveryWindowOptionsForbidden %s", 403, payload)
}
...
func (o *ConfirmDeliveryWindowOptionsForbidden) GetPayload() *models.ErrorList {
	return o.Payload
}
...
// Code gets the status code for the confirm delivery window options not found response
func (o *ConfirmDeliveryWindowOptionsNotFound) Code() int {
	return 404
}

func (o *ConfirmDeliveryWindowOptionsNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /inbound/fba/2024-03-20/inboundPlans/{inboundPlanId}/shipments/{shipmentId}/deliveryWindowOptions/{deliveryWindowOptionId}/confirmation][%d] confirmDeliveryWindowOptionsNotFound %s", 404, payload)
}
...
func (o *ConfirmDeliveryWindowOptionsNotFound) GetPayload() *models.ErrorList {
	return o.Payload
}
...
// Code gets the status code for the confirm delivery window options request entity too large response
func (o *ConfirmDeliveryWindowOptionsRequestEntityTooLarge) Code() int {
	return 413
}

func (o *ConfirmDeliveryWindowOptionsRequestEntityTooLarge) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /inbound/fba/2024-03-20/inboundPlans/{inboundPlanId}/shipments/{shipmentId}/deliveryWindowOptions/{deliveryWindowOptionId}/confirmation][%d] confirmDeliveryWindowOptionsRequestEntityTooLarge %s", 413, payload)
}
...
func (o *ConfirmDeliveryWindowOptionsRequestEntityTooLarge) GetPayload() *models.ErrorList {
	return o.Payload
}
...
// Code gets the status code for the confirm delivery window options unsupported media type response
func (o *ConfirmDeliveryWindowOptionsUnsupportedMediaType) Code() int {
	return 415
}

func (o *ConfirmDeliveryWindowOptionsUnsupportedMediaType) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /inbound/fba/2024-03-20/inboundPlans/{inboundPlanId}/shipments/{shipmentId}/deliveryWindowOptions/{deliveryWindowOptionId}/confirmation][%d] confirmDeliveryWindowOptionsUnsupportedMediaType %s", 415, payload)
}
...
func (o *ConfirmDeliveryWindowOptionsUnsupportedMediaType) GetPayload() *models.ErrorList {
	return o.Payload
}
...
// Code gets the status code for the confirm delivery window options too many requests response
func (o *ConfirmDeliveryWindowOptionsTooManyRequests) Code() int {
	return 429
}

func (o *ConfirmDeliveryWindowOptionsTooManyRequests) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /inbound/fba/2024-03-20/inboundPlans/{inboundPlanId}/shipments/{shipmentId}/deliveryWindowOptions/{deliveryWindowOptionId}/confirmation][%d] confirmDeliveryWindowOptionsTooManyRequests %s", 429, payload)
}
...
func (o *ConfirmDeliveryWindowOptionsTooManyRequests) GetPayload() *models.ErrorList {
	return o.Payload
}
...
// Code gets the status code for the confirm delivery window options internal server error response
func (o *ConfirmDeliveryWindowOptionsInternalServerError) Code() int {
	return 500
}

func (o *ConfirmDeliveryWindowOptionsInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /inbound/fba/2024-03-20/inboundPlans/{inboundPlanId}/shipments/{shipmentId}/deliveryWindowOptions/{deliveryWindowOptionId}/confirmation][%d] confirmDeliveryWindowOptionsInternalServerError %s", 500, payload)
}
...
func (o *ConfirmDeliveryWindowOptionsInternalServerError) GetPayload() *models.ErrorList {
	return o.Payload
}
...
// Code gets the status code for the confirm delivery window options service unavailable response
func (o *ConfirmDeliveryWindowOptionsServiceUnavailable) Code() int {
	return 503
}

func (o *ConfirmDeliveryWindowOptionsServiceUnavailable) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /inbound/fba/2024-03-20/inboundPlans/{inboundPlanId}/shipments/{shipmentId}/deliveryWindowOptions/{deliveryWindowOptionId}/confirmation][%d] confirmDeliveryWindowOptionsServiceUnavailable %s", 503, payload)
}
...
func (o *ConfirmDeliveryWindowOptionsServiceUnavailable) GetPayload() *models.ErrorList {
	return o.Payload
}
