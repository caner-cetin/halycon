...
func (o *ListPackingOptionsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 503:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[GET /inbound/fba/2024-03-20/inboundPlans/{inboundPlanId}/packingOptions] listPackingOptions", response, response.Code())
	}
}
...
type ListPackingOptionsOK struct {
	...
	Payload *models.ListPackingOptionsResponse
}
...
// Code gets the status code for the list packing options o k response
func (o *ListPackingOptionsOK) Code() int {
	return 200
}

func (o *ListPackingOptionsOK) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /inbound/fba/2024-03-20/inboundPlans/{inboundPlanId}/packingOptions][%d] listPackingOptionsOK %s", 200, payload)
}
...
func (o *ListPackingOptionsOK) GetPayload() *models.ListPackingOptionsResponse {
	return o.Payload
}
...
func (o *ListPackingOptionsOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models.ListPackingOptionsResponse)
...
// Code gets the status code for the list packing options bad request response
func (o *ListPackingOptionsBadRequest) Code() int {
	return 400
}

func (o *ListPackingOptionsBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /inbound/fba/2024-03-20/inboundPlans/{inboundPlanId}/packingOptions][%d] listPackingOptionsBadRequest %s", 400, payload)
}
...
func (o *ListPackingOptionsBadRequest) GetPayload() *models.ErrorList {
	return o.Payload
}
...
// Code gets the status code for the list packing options forbidden response
func (o *ListPackingOptionsForbidden) Code() int {
	return 403
}

func (o *ListPackingOptionsForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /inbound/fba/2024-03-20/inboundPlans/{inboundPlanId}/packingOptions][%d] listPackingOptionsForbidden %s", 403, payload)
}
...
func (o *ListPackingOptionsForbidden) GetPayload() *models.ErrorList {
	return o.Payload
}
...
// Code gets the status code for the list packing options not found response
func (o *ListPackingOptionsNotFound) Code() int {
	return 404
}

func (o *ListPackingOptionsNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /inbound/fba/2024-03-20/inboundPlans/{inboundPlanId}/packingOptions][%d] listPackingOptionsNotFound %s", 404, payload)
}
...
func (o *ListPackingOptionsNotFound) GetPayload() *models.ErrorList {
	return o.Payload
}
...
// Code gets the status code for the list packing options request entity too large response
func (o *ListPackingOptionsRequestEntityTooLarge) Code() int {
	return 413
}

func (o *ListPackingOptionsRequestEntityTooLarge) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /inbound/fba/2024-03-20/inboundPlans/{inboundPlanId}/packingOptions][%d] listPackingOptionsRequestEntityTooLarge %s", 413, payload)
}
...
func (o *ListPackingOptionsRequestEntityTooLarge) GetPayload() *models.ErrorList {
	return o.Payload
}
...
// Code gets the status code for the list packing options unsupported media type response
func (o *ListPackingOptionsUnsupportedMediaType) Code() int {
	return 415
}

func (o *ListPackingOptionsUnsupportedMediaType) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /inbound/fba/2024-03-20/inboundPlans/{inboundPlanId}/packingOptions][%d] listPackingOptionsUnsupportedMediaType %s", 415, payload)
}
...
func (o *ListPackingOptionsUnsupportedMediaType) GetPayload() *models.ErrorList {
	return o.Payload
}
...
// Code gets the status code for the list packing options too many requests response
func (o *ListPackingOptionsTooManyRequests) Code() int {
	return 429
}

func (o *ListPackingOptionsTooManyRequests) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /inbound/fba/2024-03-20/inboundPlans/{inboundPlanId}/packingOptions][%d] listPackingOptionsTooManyRequests %s", 429, payload)
}
...
func (o *ListPackingOptionsTooManyRequests) GetPayload() *models.ErrorList {
	return o.Payload
}
...
// Code gets the status code for the list packing options internal server error response
func (o *ListPackingOptionsInternalServerError) Code() int {
	return 500
}

func (o *ListPackingOptionsInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /inbound/fba/2024-03-20/inboundPlans/{inboundPlanId}/packingOptions][%d] listPackingOptionsInternalServerError %s", 500, payload)
}
...
func (o *ListPackingOptionsInternalServerError) GetPayload() *models.ErrorList {
	return o.Payload
}
...
// Code gets the status code for the list packing options service unavailable response
func (o *ListPackingOptionsServiceUnavailable) Code() int {
	return 503
}

func (o *ListPackingOptionsServiceUnavailable) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /inbound/fba/2024-03-20/inboundPlans/{inboundPlanId}/packingOptions][%d] listPackingOptionsServiceUnavailable %s", 503, payload)
}
...
func (o *ListPackingOptionsServiceUnavailable) GetPayload() *models.ErrorList {
	return o.Payload
}
