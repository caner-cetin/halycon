...
func (o *ListTransportationOptionsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 503:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[GET /inbound/fba/2024-03-20/inboundPlans/{inboundPlanId}/transportationOptions] listTransportationOptions", response, response.Code())
	}
}
...
type ListTransportationOptionsOK struct {
	...
	Payload *models.ListTransportationOptionsResponse
}
...
// Code gets the status code for the list transportation options o k response
func (o *ListTransportationOptionsOK) Code() int {
	return 200
}

func (o *ListTransportationOptionsOK) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /inbound/fba/2024-03-20/inboundPlans/{inboundPlanId}/transportationOptions][%d] listTransportationOptionsOK %s", 200, payload)
}
...
func (o *ListTransportationOptionsOK) GetPayload() *models.ListTransportationOptionsResponse {
	return o.Payload
}
...
func (o *ListTransportationOptionsOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models.ListTransportationOptionsResponse)
...
// Code gets the status code for the list transportation options bad request response
func (o *ListTransportationOptionsBadRequest) Code() int {
	return 400
}

func (o *ListTransportationOptionsBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /inbound/fba/2024-03-20/inboundPlans/{inboundPlanId}/transportationOptions][%d] listTransportationOptionsBadRequest %s", 400, payload)
}
...
func (o *ListTransportationOptionsBadRequest) GetPayload() *models.ErrorList {
	return o.Payload
}
...
// Code gets the status code for the list transportation options forbidden response
func (o *ListTransportationOptionsForbidden) Code() int {
	return 403
}

func (o *ListTransportationOptionsForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /inbound/fba/2024-03-20/inboundPlans/{inboundPlanId}/transportationOptions][%d] listTransportationOptionsForbidden %s", 403, payload)
}
...
func (o *ListTransportationOptionsForbidden) GetPayload() *models.ErrorList {
	return o.Payload
}
...
// Code gets the status code for the list transportation options not found response
func (o *ListTransportationOptionsNotFound) Code() int {
	return 404
}

func (o *ListTransportationOptionsNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /inbound/fba/2024-03-20/inboundPlans/{inboundPlanId}/transportationOptions][%d] listTransportationOptionsNotFound %s", 404, payload)
}
...
func (o *ListTransportationOptionsNotFound) GetPayload() *models.ErrorList {
	return o.Payload
}
...
// Code gets the status code for the list transportation options request entity too large response
func (o *ListTransportationOptionsRequestEntityTooLarge) Code() int {
	return 413
}

func (o *ListTransportationOptionsRequestEntityTooLarge) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /inbound/fba/2024-03-20/inboundPlans/{inboundPlanId}/transportationOptions][%d] listTransportationOptionsRequestEntityTooLarge %s", 413, payload)
}
...
func (o *ListTransportationOptionsRequestEntityTooLarge) GetPayload() *models.ErrorList {
	return o.Payload
}
...
// Code gets the status code for the list transportation options unsupported media type response
func (o *ListTransportationOptionsUnsupportedMediaType) Code() int {
	return 415
}

func (o *ListTransportationOptionsUnsupportedMediaType) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /inbound/fba/2024-03-20/inboundPlans/{inboundPlanId}/transportationOptions][%d] listTransportationOptionsUnsupportedMediaType %s", 415, payload)
}
...
func (o *ListTransportationOptionsUnsupportedMediaType) GetPayload() *models.ErrorList {
	return o.Payload
}
...
// Code gets the status code for the list transportation options too many requests response
func (o *ListTransportationOptionsTooManyRequests) Code() int {
	return 429
}

func (o *ListTransportationOptionsTooManyRequests) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /inbound/fba/2024-03-20/inboundPlans/{inboundPlanId}/transportationOptions][%d] listTransportationOptionsTooManyRequests %s", 429, payload)
}
...
func (o *ListTransportationOptionsTooManyRequests) GetPayload() *models.ErrorList {
	return o.Payload
}
...
// Code gets the status code for the list transportation options internal server error response
func (o *ListTransportationOptionsInternalServerError) Code() int {
	return 500
}

func (o *ListTransportationOptionsInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /inbound/fba/2024-03-20/inboundPlans/{inboundPlanId}/transportationOptions][%d] listTransportationOptionsInternalServerError %s", 500, payload)
}
...
func (o *ListTransportationOptionsInternalServerError) GetPayload() *models.ErrorList {
	return o.Payload
}
...
// Code gets the status code for the list transportation options service unavailable response
func (o *ListTransportationOptionsServiceUnavailable) Code() int {
	return 503
}

func (o *ListTransportationOptionsServiceUnavailable) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /inbound/fba/2024-03-20/inboundPlans/{inboundPlanId}/transportationOptions][%d] listTransportationOptionsServiceUnavailable %s", 503, payload)
}
...
func (o *ListTransportationOptionsServiceUnavailable) GetPayload() *models.ErrorList {
	return o.Payload
}
