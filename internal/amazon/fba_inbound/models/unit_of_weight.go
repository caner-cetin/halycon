...
const (
	...
	// UnitOfWeightLB captures enum value "LB"
	UnitOfWeightLB UnitOfWeight = "LB"

	// UnitOfWeightKG captures enum value "KG"
	UnitOfWeightKG UnitOfWeight = "KG"
)
...
func init() {
	...
	if err := json.Unmarshal([]byte(`["LB","KG"]`), &res); err != nil {
		panic(err)
	}
	for _, v := range res {
